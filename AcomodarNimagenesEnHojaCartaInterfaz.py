	...
	def obtener_dimensiones_matriz(argument):
		...
		switcher = {
		    ...
		    21: [(7,3),(3,7)],
                    ...
                    27: [(9,3),(3,9),(4,7),(7,4)],
                    28: [(4,7),(7,4)],
                    29: [(6,5),(5,6),(10,3),(3,10),(4,8),(8,4)],
                    30: [(6,5),(5,6),(10,3),(3,10),(4,8),(8,4)],
                    31: [(11,3),(3,11),(4,8),(8,4)],
                    32: [(4,8),(8,4),(11,3),(3,11)]
		}
...
#		self.ImagenResultadoColumnas=612*2
	...
	def GenerarImagen (self,NombreArchivoPDF="zzzPDf2"):
		...
		self.collageF.save(self.path)

		with open(NombreArchivoPDF+".pdf","wb") as f:
	...
	def GenerarImagenCuadradas (self,NombreArchivoPDF="zzzPDf2"):
                #
                #Modificacion Enero 8, 2024
                # Se agrega este modo para que no respete la relacion de aspecto, sino que basado en la cuadricular (2x2), cada imagen
                #se ajuste a dividr la hoja blanca en cuatro pedazos, y luego forzar a la imagen a la resolucion correspondiente de su cuadricula
                
                #TODO: Agregar a la interfaz principal mediante un CheckBox para seleccionar esta funcion y no la original
		print ("Archivo de Imagen de Salida: ",self.path)
		for i in self.listaImagenes:
			print ("\t",i)		
			...
			for j in range (0,Columnas):
				...
				if (self.indice_image < self.ImagenesAAcomodar):
					...
					if FijarResolucionPorAltura:
						...
						filas_temporal =IncrementoY
						#while (True):
						new_height =IncrementoY 
						new_width = IncrementoX
						#	print ("Dimensiones Nuevas h,w",new_height,new_width,IncrementoY,IncrementoX)
						#	filas_temporal-=10
						#	if (new_width<IncrementoX) and (new_height<IncrementoY):
						#		break
...
print ("Kguama")
#A = AcomodoImagenes(listaArchivosR,r'temporal.png',12,(4,3))
#A.GenerarImagen()
#A = AcomodoImagenes(listaArchivosR,r'temporal.png',8,(4,2))
#A.GenerarImagen()
#A.GenerarImagenCuadradas()
