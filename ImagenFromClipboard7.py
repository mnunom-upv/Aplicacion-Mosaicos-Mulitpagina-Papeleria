...
class MyCustomWid(QWidget):
    def __init__(self, label, imagePath, pixmapTBP=None, parent=None):
...
#        self.setItemWidget(item2,label2)
    ...
    def agregar(self,texto="Bla",pixmap=None):
        imagePath = "Moon.png"
        label = MyCustomWid(texto, imagePath,pixmapTBP=pixmap)
        item = QListWidgetItem()
...
class MyWindow(QDialog):
    def __init__(self):
        ...
        mainLayout2.addWidget(QPushButton("Borrar Ultima Agregada"))
